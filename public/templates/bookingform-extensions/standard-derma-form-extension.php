                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input class="form-control simple_hide" type="file" capture="user" name="booking_image_1" id="booking_image_1" accept="image/*" placeholder="<?php echo esc_attr__( 'Choose image 1', 'doctor2go-connect' ); ?>">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input class="form-control simple_hide" type="file" capture="user" name="booking_image_2" id="booking_image_2" accept="image/*" placeholder="<?php echo esc_attr__( 'Choose image 2', 'doctor2go-connect' ); ?>">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input class="form-control simple_hide" type="file" capture="user" name="booking_image_3" id="booking_image_3" accept="image/*" placeholder="<?php echo esc_attr__( 'Choose image 3', 'doctor2go-connect' ); ?>">
                        </div>
                    </div>
                    <?php if ( wpmd_is_phone() ) { ?>
                        </div>
