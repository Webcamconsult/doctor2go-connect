            ...
            <div class="card mb-5 ">
                <div class="card-body">
                    ...
                    <?php if (isset($_GET['use_ai_info']) && '1' === $_GET['use_ai_info']) { ?>
                        <div class="opener"><strong><?php echo esc_html__('Edit your information', 'doctor2go-connect'); ?></strong><span class="icon d2cif-Arrow-small-down text-small"></span>
                            <p class="text-small"><?php echo esc_html__('Pre-filled from your AI check.', 'doctor2go-connect'); ?></p>
                        </div>
                    <?php } ?>
